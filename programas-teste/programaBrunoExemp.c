...
void processarAlunos(RegistroAluno aluno);
...
int main()
{
    // Declatar uma variável do tipo Registro: RegistroAluno
    RegistroAluno aluno1;
    RegistroAluno aluno2;
    RegistroAluno aluno3;

    processarAlunos(aluno1);
    processarAlunos(aluno2);
    processarAlunos(aluno3);
